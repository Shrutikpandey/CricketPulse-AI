...
| **Data** | 1,095 IPL matches | 260,920 deliveries | 99 live news headlines |
| **Tools** | Python | Power BI | Jupyter Notebook | NewsAPI | TextBlob |
...
2. Navigate to notebooks folder and open Jupyter
```bash
jupyter notebook
```
...
4. Add your NewsAPI key in `03_News_Sentiment_Analysis.ipynb`:
```python
...
- ✅ [Business Requirements Document (BRD)](./reports/BRD-CricketPulse-AI-BCCI.pdf)
...
Raw deliveries data not included due to file size (260,920 rows). Cleaned CSV files are provided. Original data available at [Kaggle IPL Dataset](https://www.kaggle.com/datasets/patrickb1912/ipl-complete-dataset-20082020).
...
🔗 [LinkedIn](https://linkedin.com/in/shrutikumaripandey)
🐙 [GitHub](https://github.com/Shrutikpandey)
